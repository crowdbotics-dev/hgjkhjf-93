"""
Django settings for hgjkhjf_93 project.
...
WSGI_APPLICATION = 'hgjkhjf_93.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hgjkhjf_93 API",
    "DESCRIPTION": "API documentation for hgjkhjf_93 App",
    "VERSION": "v1",
}
